const PrivacyPolicy = () => {
  return (
    <main className="min-h-[600px] flex flex-col justify-center items-center mt-36">
      <div className="w-[90%] text-center">
        <h1 className="text-[20px] font-bold">Privacy Policy</h1>
        <div className="text-start my-[60px]">
          <p className="mb-[10px]">Effective Date: September 20, 2023.</p>
          <section>
            <p>
              At CoinView, we’re strongly committed to protecting and respecting
              your privacy.
            </p>
            <p>
              This Privacy Policy (“Privacy Policy”) covers your access and use
              of this website, coinView.com (the “Website”), as well as
          ...
          <section>
            ...
            <p>
              CoinView (“CoinView”, “we” or “us”) collects (a) the e-mail
            ...
            <p>
              ...
              age of 18. By using the CoinView service, you are representing
          ...
          <section>
            ...
            <p>
              ...
              personal information should be addressed to legal@coinView.com.
            </p>
          </section>
        </div>
      </div>
