...
export const PortFolioTracker = () => {
  ...
  return (
    <main
      className={`mt-[130px] md:mt-[155px] overflow-x-hidden md:min-h-[1100px]`}
    >
          ...
          <div className="md:pl-0 pl-2 md:mt-0 mt-4 h-[100%]">
            <div className="md:h-[100%] text-center flex justify-between">
              <div className="hidden md:flex md:w-[20%] pt-4 pl-2">
                <div
                  className={`w-[3vw] h-[4vh] rounded-lg border-2 ${
                  ...
                  >
                    <li className="text-gray-300 list-disc">
                      ...
                      <button
                        ...
                        } hover:underline decoration-1 hover:text-red-200 text-[1.4vw]`}
                        onClick={onWallet}
                      >
                        지갑연결 방법
                      </button>
              ...
              <div className={`pt-2 pr-2 md:pt-4`}>
                <button
                  className={`h-8 bg-blue-500 rounded-lg hover:bg-blue-700 w-25 shadow ${
                    darkMode ? "shadow-white" : "shadow-black"
                  }`}
                >
            ...
            <div className=" md:pl-2 md:flex md:justify-between">
              <div className="md:w-[48%] md:h-[30%] md:p-0 p-2">
                <div>
                  <div
                    className={`flex rounded w-[100%] h-[80px] shadow-md ${
                      darkMode ? "shadow-white" : "shadow-black"
                    }`}
                    onClick={walleOpentModal}
                  >
