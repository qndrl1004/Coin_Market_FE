        ...
        <div className="w-full md:w-[80%] h-[100%]">
          <div className="pt-[3%]">
            <div className="flex items-center justify-center md:justify-start ">
              <span className="cursor-default md:absolute md:top-[15%] bg-blue-600 rounded px-1 text-white text-[1vw] mx-1">
                Main
              </span>
              ...
              <button onClick={onBtnShowInput}>
                {showInput ? (
                  ...
                  <div className="flex items-center justify-center w-5 h-5 px-2 bg-gray-200 rounded">
              ...
              <button
                ...
                onClick={offBtnShowInput}
              >
                닫기
              </button>

              <button className="flex justify-center pl-2" onClick={onShowList}>
                {!showList ? (
                  <div>
                    <FontAwesomeIcon
                      className="text-[2vw] md:text-[1vw] mb-1"
                      icon={faChevronUp}
                    />
                  </div>
                ) : (
            ...
            <div>
              <ul
                className="w-[100%] md:w-[25%] text-center"
                style={{
                  borderBottom: showList ? "#e5e7eb 2px solid" : "none",
                }}
              >
                {nameList.map((arr, index) => (
                  <li
                    className="border-t-2 hover:bg-gray-200"
                    key={index}
