      ...
      <section className='w-screen'>
        <div className='md:flex items-center justify-between bg-black text-white'>
          ...
          <div className=' hidden md:block visible w-[800px]'>
            ...
            <div className='flex justify-center items-center inset-y-0 right-0 my-6 mr-20 border-1 border-white rounded-xl border-opacity-70 overflow-hidden shadow-lg shadow-white'>
