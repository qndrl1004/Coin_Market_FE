...
const page1 = [
  <>
    <div className={`mb-[1vh] text-center font-semibold text-xl`}>
      지갑 발금방법
    </div>
    <div className="flex-1 overflow-auto text-black bg-gray-300 rounded">
      <div>
        ...
        <img
          src="https://content.bithumb.com/admin_img/202208221655281812911908.png"
          alt=""
        />
        <img
          src="https://content.bithumb.com/admin_img/20220822165643773955666.png"
          alt=""
        />
        <img
          src="https://content.bithumb.com/admin_img/202208221656581131886458.png"
          alt=""
        />
        <img
          src="https://content.bithumb.com/admin_img/202208221658491492664900.png"
          alt=""
        />
...
export const BookModal: React.FC<BookModalProps> = ({
  ...
  const selectedArray =
    isNames === "page1" ? page1 : isNames === "page2" ? page2 : [];
  const prevPage = () => {
    if (currentPage > 0) {
